  ...
  return (
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <Link to ="/" className='text-2x1 font-bold text-lg text-blue-700 flex items-center gap-2'><FaBookOpenReader className='size-8 inline-block '/>Kitebi</Link>

                <p className="text-base leading-relaxed text-gray-600 mt-7">Kitebi is the world’s largest site for readers and book recommendations. Our mission is to help readers discover books they love and get more out of reading. Kitebi launched in April 2024.</p>
            ...
            <div>
                <p className="text-sm font-semibold tracking-widest text-gray-400 uppercase">Website</p>
                ...
                <ul className="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Authors </a>
                    </li>

                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Books </a>
                    </li>

                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Advertise </a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul className="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Work with us </a>
                    </li>
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by <span className='text-blue-500 font-bold'>Kitebi</span></p>
    </div>
</section>
  )
}
